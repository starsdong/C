...
#include "iomanip.h"
/*
void plot(const TH1* d0, double x1=0., double x2=1., double y1=0., double y2=10., const char* xtitle="p_{T} (GeV/c)", const char* ytitle="(d^{2}N)/(2#pip_{T}dp_{T}dy) (GeV/c)^{-2}", const char* output="test", const int logy=0)
{
